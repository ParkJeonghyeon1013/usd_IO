...
################################################################################
## Form generated from reading UI file 'sample_window6.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_7 = QGridLayout(self.tab1)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.scrollArea = QScrollArea(self.tab1)
        self.scrollArea.setObjectName(u"scrollArea")
        self.scrollArea.setMinimumSize(QSize(170, 0))
        self.scrollArea.setMaximumSize(QSize(170, 16777215))
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 168, 602))
        ...
        self.lineEdit__grid = QLineEdit(self.groupBox__grayscale)
        self.lineEdit__grid.setObjectName(u"lineEdit__grid")

        self.horizontalLayout_2.addWidget(self.lineEdit__grid)

        self.toolButton__grid = QToolButton(self.groupBox__grayscale)
        self.toolButton__grid.setObjectName(u"toolButton__grid")

        self.horizontalLayout_2.addWidget(self.toolButton__grid)
        ...
        self.lineEdit__city_name.setEnabled(False)

        self.verticalLayout__name.addWidget(self.lineEdit__city_name)

        self.pushButton__build = QPushButton(self.groupBox__name)
        self.pushButton__build.setObjectName(u"pushButton__build")
        self.pushButton__build.setEnabled(False)

        self.verticalLayout__name.addWidget(self.pushButton__build)
        ...
        self.gridLayout_4.addWidget(self.frame__img1, 0, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frame__img2, 0, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frame__img3, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frame__img4, 1, 1, 1, 1)


        self.gridLayout_6.addWidget(self.groupBox__image, 0, 0, 1, 1)

        self.groupBox_10 = QGroupBox(self.frame__image)
        self.groupBox_10.setObjectName(u"groupBox_10")
        self.groupBox_10.setMinimumSize(QSize(832, 110))
        self.gridLayout_8 = QGridLayout(self.groupBox_10)
        self.gridLayout_8.setObjectName(u"gridLayout_8")
        self.verticalLayout_7 = QVBoxLayout()
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.progressBar__build = QProgressBar(self.groupBox_10)
        self.progressBar__build.setObjectName(u"progressBar__build")
        self.progressBar__build.setValue(0)

        self.verticalLayout_7.addWidget(self.progressBar__build)

        self.textEdit__log = QTextEdit(self.groupBox_10)
        self.textEdit__log.setObjectName(u"textEdit__log")
        self.textEdit__log.setEnabled(False)
        self.textEdit__log.setMinimumSize(QSize(450, 60))
        self.textEdit__log.setMaximumSize(QSize(450, 61))
        self.textEdit__log.setReadOnly(True)

        self.verticalLayout_7.addWidget(self.textEdit__log)


        self.gridLayout_8.addLayout(self.verticalLayout_7, 0, 0, 2, 1)
        ...
        self.toolButton__open.setEnabled(False)
        ...
        self.pushButton__open.setEnabled(False)

        self.horizontalLayout__open.addWidget(self.pushButton__open)


        self.gridLayout_8.addLayout(self.horizontalLayout__open, 0, 1, 1, 1)
        ...
        self.comboBox__usr.setEnabled(False)
        ...
        self.pushButton__publish.setEnabled(False)

        self.horizontalLayout__publish.addWidget(self.pushButton__publish)


        self.gridLayout_8.addLayout(self.horizontalLayout__publish, 1, 1, 1, 1)


        self.gridLayout_6.addWidget(self.groupBox_10, 1, 0, 1, 1)


        self.gridLayout_7.addWidget(self.frame__image, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolButton__grid.setText(QCoreApplication.translate("MainWindow", u"...", None))
        ...
        self.groupBox__name.setTitle(QCoreApplication.translate("MainWindow", u"Build", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"City Name", None))
        self.pushButton__build.setText(QCoreApplication.translate("MainWindow", u"Build start", None))
